...
api_key = "AIzaSyC_fmJfMd--MbrJ9XvaNrHIeHc2oVkuKmI"
```
...
We observe CA_2017 and US_yt_trending_2017's trending_date is stored as characters. For example, 2017-11-14 is stored as character 17.14.11
...
After removing outliers, the increasing trend is significant. And we can see there are more viewers per Canadian trending video in 2022 compared to 2017. After removing outliers, the increasing trend is significant.
